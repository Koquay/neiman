...
export class AppService {
  public appSignal = signal<{ 
    neiman:{selectedProduct:ProductModel, cart:ProductModel[], checkoutData:CheckoutModel, user:AuthenticationModel}
  }>({neiman:{selectedProduct: new ProductModel(), cart: [], checkoutData: new CheckoutModel(), user: new AuthenticationModel()}})
